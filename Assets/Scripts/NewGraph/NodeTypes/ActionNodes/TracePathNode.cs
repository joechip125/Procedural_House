...
{
    public class TracePathNode :ActionNode
    {
        ...
        private void StartSearch()
        {
            ...
            {
                Position = agent.enemyTransform.position,
                DistanceFromGoal = Vector3.Distance(agent.enemyTransform.position, destination)
            };
